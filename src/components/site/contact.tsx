...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden border-t border-border py-12 sm:py-16">
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-6 lg:grid-cols-[1.05fr_1fr] lg:items-start">
          <Reveal>
            <p className="term-label"><span className="text-magenta">&gt;</span> SYSTEM.COMMUNICATION<span className="caret text-magenta">_</span></p>
            <h2 className="mt-4 text-balance text-[clamp(2rem,5vw,3.2rem)] font-semibold leading-[1.05]">
              Hiring for a full-stack or AI internship? <span className="text-gradient">Let's talk.</span>
            </h2>
